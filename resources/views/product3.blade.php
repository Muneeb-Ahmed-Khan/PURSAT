            ...
            <div class="row">
                    ...
                    <div id="carouselExampleControls" class="carousel slide my-content" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="card-img-top" class="d-block w-100" src="{{ asset('images/Untitled3-.jpg') }}" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="card-img-top" class="d-block w-100" src="{{ asset('images/Untitled3-2.jpg') }}" alt="Second slide">
                            </div>
                        </div>
                ...
                <div class="col-md-6 pt-5">
                    <div class="pt-4">
                        ...
                        <span>{{ __('messages.p3.description') }}</span>
                    </div>
                    ...
                    <div class="pt-5">
                        ...
                        <span>{{ __('messages.p3.ingredients') }}</span>
